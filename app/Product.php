...
class Product extends Model
{
    ...
    {
        return self::select('products.id','name','description','price','category_id','user_seller_id','category_name','first_name','last_name','home','location_id','subcategory_child_of_id')
        ->join('categories', 'categories.id', '=', 'products.category_id')
        ->join('users','users.id','=','user_seller_id')

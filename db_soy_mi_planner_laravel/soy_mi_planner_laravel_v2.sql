...
--
-- Host: localhost    Database: soy_mi_planner_laravel
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'Lugar',NULL),(2,'Decoracion',NULL),(3,'Catering',NULL),(4,'Servicios',NULL),(5,'Otros',NULL),(6,'Salones',1),(7,'Quintas',1),(8,'Otros',1),(9,'Decoracion y ambientacion',2),(10,'Moviliario',2),(11,'Otros',2),(12,'Catering gral',3),(13,'Mesa dulce',3),(14,'Tortas de boda y cumpleaños',3),(15,'DJs y sonido',4),(16,'Foto y video',4),(17,'Animacion y shows',4),(18,'Cotillon',5),(19,'Vestidos y trajes a medida',5),(20,'Ramos y souvenirs',5),(21,'',NULL);
...
CREATE TABLE `products` (
  ...
  `user_seller_id` int(11) unsigned DEFAULT NULL,
...
INSERT INTO `products` VALUES (1,NULL,NULL,'Quinta \"Delta Parana\"','Quinta con hermosa arboleda.Capacidad entre 50 y 250 invitados.En el jardín se pueden celebrar ceremonias civiles o religiosas.La laguna es ideal para altares rodeados de cañas de bambú.','Desde $20.000',NULL,4,1),(2,NULL,NULL,'Salon \"Fiesta Inolvidable\"','Ofrecemos un espacio diseñado para la realización de eventos sociales y empresariales, con una alta calidad en sus servicios y atención al cliente.','Desde $18.000',NULL,9,1),(3,NULL,NULL,'Foto y Video \"José\"','Empresa con mas de 10 Años en el mercado ofreciendo Fotografía, Video y Gráficas para eventos.','A convenir',NULL,5,4),(4,NULL,NULL,'Catering \"Asian Delight\"','Somos una cadena de sushi y wraps y les ofrecemos el servicio de catering para cualquier tipo de evento. Una opción sana, rica y muy económica, puede incluir la preparación en vivo!','A convenir',NULL,2,3),(5,NULL,NULL,'Catering \"Sabores Criollos\"','Realizamos catering para todo tipo de eventos, tanto sociales como corporativos. Cubrimos todas sus necesidades, con menúes personalizados y soluciones integrales para cada evento.','A convenir',NULL,11,3),(6,NULL,NULL,'Cotillon \"Los Piratas\"','Fabricación de cotillón temático artesanal. Desde hace más de 20 años hacemos de las fiestas un evento exclusivo y diferente, con un estilo único y personal. ','A convenir',NULL,6,5),(7,NULL,NULL,'DJ \"Manija\"','Discjockey, música y sonido para todo tipo de eventos.','A convenir',NULL,1,4),(8,NULL,NULL,'Cotillon \"Carnaval toda al vida\"','Cotillón y accesorios para que tu fiesta sea la más original y divertida.','A convenir',NULL,7,5),(9,NULL,NULL,'Banda \"Los Cachengues\"','Banda de Covers para Eventos. Cumbia Retro, Carnaval Carioca, Cumbia Pop, Bailable Retro. 6 años de experiencia. Músicos profesionales.','Desde $3.000',NULL,8,4),(10,NULL,NULL,'Moviliario para eventos \"Silla&Sillon\"','Somos una empresa familiar dedicada al alquiler de mesas, sillas y sillones para eventos.','A convenir',NULL,3,2),(11,NULL,NULL,'Tortas de Boda \"Ensueño\"','Ofrecemos servicios de y pastelería cuidando siempre cada detalle y utilizando las mejores materias primas.','Desde $1.000',NULL,11,3),(12,NULL,NULL,'Iluminacion \"Que flash!\"','Imagen e iluminación, proyecciones, luminarias leds, ambientación, efectos ópticos, iluminación robotizada, cabezales móviles, scanners, laser shows, máquinas de humo, efectos y más.','A convenir',NULL,1,2),(13,'2017-07-17 19:15:33','2017-07-17 19:15:33','test','sdfghj','3456',NULL,NULL,2),(14,'2017-07-17 22:54:35','2017-07-17 22:54:35','test2','cjkl','1234',NULL,NULL,2),(16,'2017-07-17 22:59:33','2017-07-17 22:59:33','dfghjk','hjkd','34567','16.dfghjk.jpeg',NULL,1);
...
-- Dump completed on 2017-07-18 11:35:59
